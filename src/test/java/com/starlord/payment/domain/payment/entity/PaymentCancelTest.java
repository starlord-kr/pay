...
public class PaymentCancelTest {
    ...
    @Autowired PaymentCancelRepository paymentCancelRepository;
    ...
    public void approvePaymentTest() throws GeneralSecurityException {
        PaymentApproval paymentApproval = paymentApprovalRepository.save(preparedApproval());
        PaymentCancel expected = PaymentCancel.builder()
                ...
                .cancelVat(91L)
                .build();
        PaymentCancel acaual = paymentCancelRepository.save(expected);
        ...
        // 승인값과 관계도 확인해본다.
        assertThat(acaual.getPaymentApproval().getId(), is(paymentApproval.getId()));
    }

    PaymentApproval preparedApproval() {
